...
//--------------------| MALVIN-XMD Sesion Output |--------------------//

if (!fs.existsSync(__dirname + '/session/creds.json')) {
    if(!config.SESSION_ID) return console.log('❎ 𝙼𝙰𝙻𝚅𝙸𝙽-𝚇𝙼𝙳 - Please Add Your Session...')
    ...
    filer.download((err, data) => {
        ...
        fs.writeFile(__dirname + '/session/creds.json', data, () => {
            ...
            console.log("♻️ 𝙼𝙰𝙻𝚅𝙸𝙽-𝚇𝙼𝙳 - 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍𝚒𝚗𝚐 𝚂𝚎𝚜𝚜𝚒𝚘𝚗...")
        })
    })
}
...
async function connectToWA() {
    ...
    console.log("✅ 𝙼𝙰𝙻𝚅𝙸𝙽-𝚇𝙼𝙳 - 𝚂𝚎𝚜𝚜𝚒𝚘𝚗 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙲𝚘𝚖𝚙𝚕𝚎𝚝𝚎𝚍....");
    ...
    conn.ev.on('connection.update', (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log('♻️𝙼𝙰𝙻𝚅𝙸𝙽 𝚇𝙼𝙳 - 𝙸𝙽𝚂𝚃𝙰𝙻𝙻𝙸𝙽𝙶 𝙿𝙻𝚄𝙶𝙸𝙽𝚂 𝙵𝙸𝙻𝙴𝚂 𝙿𝙻𝙴𝙰𝚂𝙴 𝚆𝙰𝙸𝚃... 🪄')
            console.log('✅𝙼𝙰𝙻𝚅𝙸𝙽-𝚇𝙼𝙳 - 𝙿𝚕𝚞𝚐𝚒𝚗 𝙸𝚗𝚜𝚝𝚊𝚕𝚕 𝙲𝚘𝚖𝚙𝚕𝚎𝚝𝚎𝚍 ...')
            console.log('✅ 𝙼𝙰𝙻𝚅𝙸𝙽-𝚇𝙼𝙳 - 𝚂𝚞𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕 𝙲𝚘𝚗𝚎𝚌𝚝𝚎𝚍 𝚈𝚘𝚞𝚛 𝙳𝚎𝚟𝚒𝚌𝚎...')
            const path = require('path');
            ...
            let up = config.START_MSG;
                        const inviteCode =`Bc4R9deNzaGB5CA68syLkC`
...
app.listen(port, () => console.log(`✅ 𝙼𝙰𝙻𝚅𝙸𝙽-𝚇𝙼𝙳 - 𝚂𝚎𝚛𝚟𝚎𝚛 𝚁𝚞𝚗𝚗𝚒𝚗𝚐......`));
setTimeout(() => {
    connectToWA()
}, 4000);
